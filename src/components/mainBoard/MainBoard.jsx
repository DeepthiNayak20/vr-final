...
const MainBoard = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `http://virtuallearnadmin-env.eba-vvpawj4n.ap-south-1.elasticbeanstalk.com/admin/coursesAdded?pageNumber=1&limit=2`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem('token')}`,
          },
              ...
              <div className="mainboard-recent-list">
                <div className="thumbnail-delete">
                  <div className="recent-title">
                    ...
                    <div className="recent-coursetitle">{res.courseName}</div>
                  </div>
